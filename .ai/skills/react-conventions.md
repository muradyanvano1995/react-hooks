...
- Prefer `useEffect` for subscriptions and observer setup. Avoid `useLayoutEffect` unless before-paint work is required; React 18 emits an SSR warning when server-rendering components that call it.
